    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-gray-800">💪 Workout</h1>
                    <p className="text-gray-500 mt-1">Track your daily workout plans</p>
                </div>
                <button
                    onClick={handleAdd}
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {workouts.map((workout) => (
                        <div key={workout.id} className="bg-white rounded-2xl shadow p-5">
